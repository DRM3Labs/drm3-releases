...
class Pistachio < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "04f8d7f41b7b9807d5aef118427782320ccf9bdc1bb186a9b7617cb1431c2369"
    end
    on_intel do
      url "https://github.com/drm3labs/drm3-releases/releases/download/pistachio-v#{version}/pistachio-darwin-amd64"
      sha256 "9f1e8582781203da9e40870476ed3844f060b963d05fa4f6becd80482e58b540"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "bdb67511a7e617df8d020826becc70fbc19b3851eae0e400977c7d9e419fd4ff"
    end
    on_intel do
      url "https://github.com/drm3labs/drm3-releases/releases/download/pistachio-v#{version}/pistachio-linux-amd64"
      sha256 "63b9842e2c029d240fbfa094329d58a6f705f6b2049dbde3532ae9d4f0ea9f95"
    end
  end

...
class Pistachio < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "e2efee70a845c0ddb213a2707ffdbdbac6275f3a1edcf97d5742fb0a123785a6"
    end
    on_intel do
      url "https://github.com/drm3labs/drm3-releases/releases/download/pistachio-v#{version}/pistachio-darwin-amd64"
      sha256 "126ecbe871a46e943a47fed19f6ae574242a4b1716d4aa5041644419c25c1ad2"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "132d355c2c318ba0f521c13795cfab439b36c5d605bb5ae4dd3cd01fe77fe089"
    end
    on_intel do
      url "https://github.com/drm3labs/drm3-releases/releases/download/pistachio-v#{version}/pistachio-linux-amd64"
      sha256 "09a995908b760f0706c5627929e640106cefe18e1c91893440f27a4510a1a860"
    end
  end

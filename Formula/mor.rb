...
class Mor < Formula
  ...
  homepage "https://github.com/drm3labs/rusty-mor-staked-inference-sdk"
  version "0.1.0"
  license "LicenseRef-Proprietary"

  on_macos do
    on_arm do
      url "https://github.com/drm3labs/rusty-mor-staked-inference-sdk/releases/download/v#{version}/mor-darwin-arm64"
      sha256 "PLACEHOLDER"
    end
    on_intel do
      url "https://github.com/drm3labs/rusty-mor-staked-inference-sdk/releases/download/v#{version}/mor-darwin-amd64"
      sha256 "PLACEHOLDER"
    end
  end
  ...
  on_linux do
    on_arm do
      url "https://github.com/drm3labs/rusty-mor-staked-inference-sdk/releases/download/v#{version}/mor-linux-arm64"
      sha256 "PLACEHOLDER"
    end
    on_intel do
      url "https://github.com/drm3labs/rusty-mor-staked-inference-sdk/releases/download/v#{version}/mor-linux-amd64"
      sha256 "PLACEHOLDER"
    end
  end

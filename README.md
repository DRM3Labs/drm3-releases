...
|---------|--------|------|---------|------|
| [Pistachio](products/pistachio/README.md) | `pistachio-v0.18.7` | Rust binary + Tauri desktop | `brew install --cask pistachio` | [guide](products/pistachio/GUIDE.md) |
| [Pistachio CLI](products/pistachio/README.md) | `pistachio-v0.18.7` | CLI only (Linux, headless) | `brew install pistachio` | [guide](products/pistachio/GUIDE.md) |

...
|---------|--------|------|---------|------|
| [Pistachio](products/pistachio/README.md) | `pistachio-v0.23.13` | Rust binary + Tauri desktop | `brew install --cask pistachio-desktop` | [guide](products/pistachio/GUIDE.md) |

...
|---------|--------|------|---------|------|
| [Pistachio CLI](products/pistachio/README.md) | `pistachio-v0.18.3` | Rust binary (macOS, Linux, WSL2) | `brew install pistachio` | [guide](products/pistachio/GUIDE.md) |
| [Pistachio Desktop](products/pistachio-desktop/README.md) | `pistachio-desktop-v0.18.3` | Tauri app (macOS) | `brew install --cask pistachio` | [guide](products/pistachio-desktop/README.md) |
